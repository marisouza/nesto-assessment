...
export class ConsentPage {
    ...
    constructor(page: Page, language: 'en' | 'fr' = 'en') {
        ...
        this.partners = page.getByText(localeData.consentPartnersButton, { exact: true });
        this.agreeButton = page.getByText(localeData.consentAcceptButton);
        this.learnMoreButton = page.getByText(localeData.consentLearnMoreButton, { exact: true });
    }
    ...
    async goto() {
        const url = this.language === 'fr' ? 'https://app.qa.nesto.ca/fr/signup' : 'https://app.qa.nesto.ca/signup';
