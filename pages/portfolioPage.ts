...
export class PortfolioPage {
  ...
  constructor(page: Page, language: 'en' | 'fr' = 'en') {
    ...
    this.commPreferencesButton = page.getByTestId('communication-preferences-tab-button');
  ...
  async getUrl() {
    const url = this.language === 'fr' ? 'https://app.qa.nesto.ca/fr' : 'https://app.qa.nesto.ca';
    return url;
  }
