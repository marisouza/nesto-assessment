...
const runSignupTests = (lang: Language) => {
  test.describe(
    `Signup Page - ${lang.toUpperCase()}`,
    { tag: "@signup" },
    () => {
      test.describe(`Form Validation - ${lang.toUpperCase()}`, () => {
        ...
        test.skip("should show inline error when phone number and country selection are different", async ({
          ...
          const phoneNumberLocator =
            signupPage.page.getByText(expectedErrorText);
      ...
      test.describe(`Account Creation - ${lang.toUpperCase()}`, () => {
